...
public class EnlightenmentCenter extends RobotPlayer{
    ...
    static int numberofunitsproduced = 0;
    static int numberofmuckrakersproduced = 0;
    static int numberofslanderersproduced = 0;
    static int numberofpoliticiansproduced = 0;
